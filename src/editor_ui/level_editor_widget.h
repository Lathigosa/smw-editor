#ifndef LEVEL_EDITOR_WIDGET_H
#define LEVEL_EDITOR_WIDGET_H
...
#warning "We included file level_editor_widget.h"
...
class level_editor_widget : public QWidget
{
	Q_OBJECT
public:
	explicit level_editor_widget(SMW_ROM & rom, QWidget *parent = 0);
...
private:
	...
	QGroupBox insert_object_details;
	QVBoxLayout insert_object_details_layout;
	QLabel object_details_label;
	...
	widget_gl_level_editor level_editor;
	widget_gl_level_editor object_viewer;
